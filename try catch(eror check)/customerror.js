...
console.log(detectTriangle(1, 1, 1)); // sama sisi
console.log(detectTriangle(1, 1, 2)); // sama kaki
console.log(detectTriangle(1, 2, 3)); // sembarang
console.log(detectTriangle("a", 2, 3)); // argumen pertama harus number
